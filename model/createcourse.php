...
<div class="container">
    ...
    <form method="POST" onsubmit="return validateForm()">
        ...
        <input type="text" name="course_id" id="course_id" placeholder="Course ID (4 digits)" required>
        ...
        <input type="text" name="room" id="room" placeholder="Room Number (4 digits)" required>
